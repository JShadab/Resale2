...
CREATE DATABASE IF NOT EXISTS `resale` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `resale`;
...
-- Dumping structure for table resale.offers
...
-- Dumping data for table resale.offers: ~0 rows (approximately)
...
-- Dumping data for table resale.products: ~5 rows (approximately)
...
-- Dumping data for table resale.users: ~2 rows (approximately)
