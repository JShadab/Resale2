				...
				<c:forEach var="category" items="${applicationScope.categories }">
					...
					<div class="col-md-3">
						<div class="focus-grid w3layouts-boder1">
							...
							<a class="btn-8"
								href="/Resale2/products.jsp?category=${category }">
			...
			<div class="agile-trend-ads">
				...
				<ul id="flexiselDemo3">
					...
					<li>
						...
						<div class="col-md-3 biseller-column">
							<a href="single.html"> <img src="images/p10.jpg" alt="" /> <span
								class="price">&#36; 3999</span>
							</a>
							<div class="w3-ad-info">
								<h5>It is a long established fact that a reader</h5>
								<span>9 hour ago</span>
						...
						<div class="col-md-3 biseller-column">
							<a href="single.html"> <img src="images/p11.jpg" alt="" /> <span
								class="price">&#36; 2699</span>
							</a>
							<div class="w3-ad-info">
								<h5>passage of Lorem Ipsum you need to be</h5>
								<span>1 day ago</span>
						...
						<div class="col-md-3 biseller-column">
							<a href="single.html"> <img src="images/p12.jpg" alt="" /> <span
